...
// rpg.js — stable, closure-based event handlers (no inline onclick), full text
  ...
  const story = [
    ...
    },
    {
      ...
      options: [
        ...
        { text: "Kjøper 3 0,6 og en akevitt", consequence: "Slipper ikke inn på flyet, men GP dukker opp og kjører Myklus til Belgia i Bentleyen.", next: 3 }
      ]
    },
    {
...
// ---------- Kapittel 2 (full tekst fra spesifikasjonen) ----------
