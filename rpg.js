// rpg.js — Chapters 1–4. Closure-baserte handlers, ingen inline onclick inne i spillet.
...
// ---------- Kapittel 5 (NYTT: Skumløs-skogen & KFC) ----------
  ...
  const story = [
    {
      ...
      options: [
        { text: "Drikke 2 Affligem før burging, fortsette med 8 Affligem", consequence: "Oppnår til slutt 6,9 i promille og blir i stand til å forstå teksten.", next: 1 },
        { text: "Veksle annenhver Affligem og Maes", consequence: "Borgermesteren hedrer nivået: Nøkkelen til Byen og en valgfri Mercedes. Promille 6,9 – teksten forstås.", next: 1 },
        { text: "Ta en lur, Pepsi Max og en joggetur for å klarne hodet", consequence: "De forviller seg mot Skumløs-skogen.", next: 1 }
      ]
    },
    {
      ...
      options: [
        ...
        { text: "Holdet er bra", consequence: "De lokale nikker anerkjennende. En mann ved døra med hatt og PC-veske bukker. KFC neste.", next: 2 },
        { text: "Holdet er fraværende", consequence: "Kelneren spytter på dem. De marsjerer til KFC.", next: 2 }
      ]
    },
    {
      text: `Obersten lyser opp veggen. Bestillingsvalg:`,
      options: [
        { text: "Liten meny med brus", consequence: "Veien peker mot Skumløs-skogen.", next: 3 },
        { text: "Medium meny med øl", consequence: "Alt for lite mat → de bestiller en stor etterpå. Fråtsing. En Slaapmutske får fett på innsiden av glasset.", next: 3 },
        { text: "Altfor stor meny med mat nok til en afrikansk landsby", consequence: "De lokale nikker. Fråtsing. En Slaapmutske får fett på innsiden av glasset.", next: 3 }
      ]
    },
    {
...
// Ensure global access (some environments require explicit export)
if (typeof window !== 'undefined') { window.startRPG = startRPG; }
