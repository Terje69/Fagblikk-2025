...
function runChapter1(container) {
  const story = [
    ...
    },
    {
      ...
      options: [
        ...
        { text: "Tilby Russe_Chris en belgisk øl", consequence: "Hunden dør i en grotesk seanse, Myklus ender i Skumløs-skogen.", next: "skumlos" },
  ...
  function showStep(stepIndex) {
    ...
    if (step.options.length === 0) {
      container.innerHTML += `<button onclick="showMainMenu()">Tilbake til hovedmeny</button>`;
      return;
    }
      ...
      btn.onclick = () => {
        if (option.next === "skumlos") {
          ...
          container.innerHTML = `<p>${option.consequence}</p>
                                 <button onclick="showStep(${option.next})">Neste</button>`;
        }
      };
  ...
  function showGameOver() {
    ...
    <button onclick="showMainMenu()">Tilbake til hovedmeny</button>`;
  }
  ...
  const story = [
    {
      ...
      options: [
        { text: "Kaste et tomt halvlitersglass med Hoegaarden mot Vegard Beid", consequence: "Treffer midt i planeten til Vegard Beid, han blir sendt inn i Leffe-baren...", next: 1 },
        { text: "Styrte et halvlitersglass Hoegaarden, kaste det tomme glasset mot Vegard Beid", consequence: "Treffer midt i planeten til Vegard Beid, han blir sendt inn til Den Siste Snille...", next: 1 }
      ]
    },
    {
      text: "Myklus får tid til å hente seg inn og møter Au Pairen som tilbyr hjelp.",
      options: [
        { text: "Takk for hjelpen, og fortsett reisen", consequence: "Myklus er nå klar for nye eventyr i Belgia.", next: 2 }
      ]
    },
    {
